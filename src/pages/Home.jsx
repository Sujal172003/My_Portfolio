    ...
    <div className="flex flex-col sm:flex-row mt-[100px] justify-center items-center sm:mt-0 sm:justify-end w-screen h-[140vh] ">
      ...
      >
        ...
        <div className="flex flex-row gap-7">
          <a href="https://github.com/Sujal172003"><FiGithub size={30} color="#c0c0c0" /></a>
          <a href="https://www.linkedin.com/in/sujal-gupta-598298255?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"><FiLinkedin size={30} color="#c0c0c0" /></a>
          <a href="https://mail.google.com/mail/?view=cm&fs=1&to=ssujal172003@gmail.com&su=Hello%20Sujal"><FiMail size={30} color="#c0c0c0" /></a>
        </div>
      </div>
      <div ref={rightRef} className="w-[30%] h-[70%] object-fill overflow-hidden mt-[80px] ">
